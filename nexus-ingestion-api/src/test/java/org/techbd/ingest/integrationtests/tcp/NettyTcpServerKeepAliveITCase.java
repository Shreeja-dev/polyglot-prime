...
class NettyTcpServerKeepAliveITCase extends BaseIntegrationTest {
     ...
     * </ul>
     *
     * <h4>Channel-attribute semantics (inferred)</h4>
     * <ul>
     *   <li>{@code SESSION_ID_KEY} — constant for the lifetime of the TCP connection.</li>
     *   <li>{@code SESSION_MESSAGE_COUNT_KEY} — reaches 2 after both messages are processed.</li>
     *   <li>{@code INTERACTION_ATTRIBUTE_KEY} — reset after each ACK (distinct S3 keys confirm this).</li>
     * </ul>
     *
