...
public class FhirController {
        ...
        private OrchestrationSession engine;
        ...
        public FhirController(@SuppressWarnings("PMD.UnusedFormalParameter") final Environment environment,
                        ...
                        @SuppressWarnings("PMD.UnusedFormalParameter") final SandboxHelpers sboxHelpers) throws IOException {
        ...
        public Object validateBundleAndForward(
                ...
                try {
                        ...
                        Map<String, String> headers = FHIRUtil.buildHeaderParametersMap(tenantId, customDataLakeApi,
                        ...
                        Map<String, String> requestParameters = FHIRUtil.buildRequestParametersMap(deleteSessionCookie,
        ...
        public Object validateBundle(
                ...
                try {
                        ...
                        request = new CustomRequestWrapper(request, payload);
                        Map<String, String> headers = FHIRUtil.buildHeaderParametersMap(tenantId, null, null,
