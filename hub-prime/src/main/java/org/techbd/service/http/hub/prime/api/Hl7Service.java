...
import org.techbd.service.hl7.converters.Hl7MessageToFhirConverter;
...
public class Hl7Service {
        ...
        private final Hl7MessageToFhirConverter hl7MessageToFhirConverter;
        ...
        public Hl7Service(final FHIRService fhirService, final UdiPrimeJpaConfig udiPrimeJpaConfig,
                        ...
                        Hl7MessageToFhirConverter hl7MessageToFhirConverter) {
                this.fhirService = fhirService;
                this.udiPrimeJpaConfig = udiPrimeJpaConfig;
                this.hl7FHIRToShinnyFHIRConverter = hl7FHIRToShinnyFHIRConverter;
                this.hl7MessageToFhirConverter = hl7MessageToFhirConverter;
        }

        public Object handleHl7Message(String hl7Payload, String tenantId, HttpServletRequest request,
...
//TODO - cal converter and db save
        ...
        public String convertToShinnyFHIRJson(org.jooq.Configuration jooqCfg, String hl7FHIRJson, String tenantId,
                ...
                LOG.info("HL7Service::convertToShinnyFHIRJson BEGIN for interactionid : {} tenantId :{} ",
                                interactionId,
                                tenantId);
                try {
        ...
        private void registerStateHl7Accept(org.jooq.Configuration jooqCfg, String hl7Payload, String hl7FHIRJson,
                        String tenantId,
                        String interactionId, HttpServletRequest request, HttpServletResponse response)
                        throws IOException {
        ...
        private Message parse(org.jooq.Configuration jooqCfg, String hl7Payload, String tenantId,
                ...
                try {
                        ...
                        return pipeParser.parse(hl7Payload);
