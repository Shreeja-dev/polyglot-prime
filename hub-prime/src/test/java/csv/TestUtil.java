...
public class TestUtil {
    ...
    public static File getTestDataDirectory()throws Exception {
        URL u = TestUtil.class.getResource("org/techbd/csv/datapackage-nyher-fhir-ig-equivalent.json");
    ...
    public static Path getBasePath() {
        try {
            ...
            Path sourceFileAbsPath = Paths.get(csv.TestUtil.class.getResource(pathName).toURI());
    ...
    public static byte[] getResourceContent (String fileName) throws IOException {
        ...
        try (InputStream inputStream = io.frictionlessdata.datapackage.Package.class.getClassLoader().getResourceAsStream(locFileName);
