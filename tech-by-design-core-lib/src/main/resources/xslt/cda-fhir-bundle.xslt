...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
  ...
  <xsl:template match="/">
  {
    ...
    , "entry": [
      <xsl:apply-templates select="/ccda:ClinicalDocument/ccda:patientRole 
        ...
        <!-- <xsl:apply-templates select="//ccda:component/ccda:structuredBody/ccda:component/ccda:section[ccda:code[@code='46240-8']]" mode="ccda:ComponentEncounter"/> -->
    ]
  }
  </xsl:template>
      ...
      "resource": {
        ...
        , "gender": "<xsl:choose>
                        ...
                        <xsl:when test="ccda:patient/ccda:administrativeGenderCode/@displayName">
                            <!-- <xsl:value-of select="lower-case(ccda:patient/ccda:administrativeGenderCode/@displayName)"/> -->
        ...
        <!-- "birthDate": "<xsl:value-of select="ccda:patient/ccda:birthTime/@value"/>", -->
  ...
  <!-- Encounter Template -->
  <!-- <xsl:template name="ComponentEncounter" match="//ccda:component/ccda:structuredBody/ccda:component/ccda:section[ccda:code[@code='46240-8']]"> -->
  ...
  <xsl:template name="Consent" match="/ccda:ClinicalDocument/ccda:consent">
    ...
    ,{
      ...
      "resource": {
        ...
        <!-- <xsl:if test="string(ccda:act/ccda:code/@displayName)">
          , "provision" : {
  ...
  <xsl:template name="Observation" match="ccda:observations/ccda:entry">
    <xsl:if test="string(ccda:observation/ccda:code/@code) != '76690-7'"> <!--string(ccda:value/@displayName) and -->
  ...
  <!-- <xsl:template name="QuestionnaireResource" match="ccda:component/ccda:section[ccda:templateId/ccda:root = '2.16.840.1.113883.19.1000.2.1']">  -->
  <xsl:template name="QuestionnaireResource" match="ccda:Questionnaire"> 
      <!--<xsl:if test="position() > 1">,</xsl:if>-->
      <!-- <xsl:variable name="questionnaireResourceId" select="translate(concat(generate-id(ccda:code/ccda:code), position(), $patientRoleId, $currentTimestamp), ':-+.', '')"/> -->
      ,{
  ...
  <!-- <xsl:template name="QuestionnaireResponseResource" match="ccda:component/ccda:section/ccda:entry[ccda:observation/ccda:code/ccda:code != '76690-7']"> -->
              ...
              ,"item": [
                  {
                      ...
                      <xsl:if test="string(ccda:value/@code) or string(ccda:value/@displayName)">
                        ,"answer" : [{
                          "valueCoding" : {
                            "system" : "http://loinc.org",  <!--"<xsl:value-of select='ccda:value/@codeSystem'/>",-->
                            "code" : "<xsl:value-of select='ccda:value/@code'/>",
                            "display" : "<xsl:value-of select='ccda:value/@displayName'/>"
                          }
                        }]                          
